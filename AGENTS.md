...
Status: **pre-code / planning done.** The Codex Design prototype has been reviewed (vendored under
`Lincoln's Reel Records - Codex Design/`), the PRD / design system / user stories are written, and all
